...
import com.sagar.logutil.databinding.GalleryImageSubCellLayoutBinding


class GallerySubImageAdapter(
    private val context: Context,val listener:OnSubImageClickListener
) : RecyclerView.Adapter<GallerySubImageAdapter.ImageViewHolder>() {
    ...
    inner class ImageViewHolder(private val binding: GalleryImageSubCellLayoutBinding) :
    ...
    private fun showDialog(context: Context, position: Int, imageDTO: ImageDTO) {
        ...
        builder.setPositiveButton("Yes") { dialogInterface, which ->
            ...
            listener.onGallerySubImageRemove(position, imageDTO)
        }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ImageViewHolder {
        ...
        val binding =
            GalleryImageSubCellLayoutBinding.inflate(layoutInflater, parent, false)
    ...
    interface OnSubImageClickListener {
        fun onGallerySubImageRemove(position: Int, imageDTO: ImageDTO)
    }
