...
import com.astrika.checqk.model.discount.HWMembershipHolderDTO
import com.sagar.logutil.databinding.MembershipHolderItemCellLayoutBinding

class HWMembershipHolderAdapter(
    private var mActivity: Activity,
    private var clickListener: OnItemClickListener
) :
    RecyclerView.Adapter<HWMembershipHolderAdapter.ViewHolder>() {

    private var arrayList = listOf<HWMembershipHolderDTO>()

    fun submitList(updatedList: List<HWMembershipHolderDTO>) {
    ...
    class ItemDiffCallback(
        private var oldList: List<HWMembershipHolderDTO>,
        private var newList: List<HWMembershipHolderDTO>
    ) : DiffUtil.Callback() {
        override fun areItemsTheSame(oldItemPosition: Int, newItemPosition: Int): Boolean {
            return (oldList[oldItemPosition].hwDiscountCardId == newList[oldItemPosition].hwDiscountCardId)
        }
    ...
    class ViewHolder(private val binding: MembershipHolderItemCellLayoutBinding) :
        ...
        fun bind(
            ...
            binding.text = dto.hwDiscountCardName ?: ""
