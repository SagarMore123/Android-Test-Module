...
class CuisineAutocompleteListAdapter(
    ...
    RecyclerView.Adapter<CuisineAutocompleteListAdapter.ViewHolder>() {

    var list = listOf<CuisineMasterDTO>()
        set(value) {
            field = value
    ...
    interface OnItemClickListener {
        fun onItemClick(position: Int, cuisineMasterDTO: CuisineMasterDTO)
