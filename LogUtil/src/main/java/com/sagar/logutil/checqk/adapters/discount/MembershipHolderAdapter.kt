...
class MembershipHolderAdapter(
    private var mActivity: Activity,
    private var clickListener: OnItemClickListener
) :
    RecyclerView.Adapter<MembershipHolderAdapter.ViewHolder>() {
    ...
    class ViewHolder(private val binding: MembershipHolderItemCellLayoutBinding) :
        ...
        fun bind(
            ...
            binding.mainLayout.setOnClickListener {
                dto.selected = true
                itemClick.onMembershipHolderItemClick(position, dto)
            }
    ...
    interface OnItemClickListener {
        fun onMembershipHolderItemClick(
            position: Int,
