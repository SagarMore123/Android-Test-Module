 ...
 * Use the [PreLoginAddressFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class PreLoginAddressFragment : Fragment(), StringTagsAdapter.OnRemoveItemClickListener,
    SocialMediaAdapter.OnRemoveDetailItemClickListener {

    private lateinit var binding: FragmentPreLoginAddressBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(
            inflater,
            R.layout.fragment_pre_login_address,
            container,
            false
        )
