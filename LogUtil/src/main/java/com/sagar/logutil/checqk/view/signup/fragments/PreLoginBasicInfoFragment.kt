...
import com.sagar.logutil.databinding.FragmentPreLoginBasicInfoBinding

/**
 * A simple [Fragment] subclass as the second destination in the navigation.
 */
class PreLoginBasicInfoFragment : Fragment(),
    ...
    private lateinit var binding: FragmentPreLoginBasicInfoBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(
            inflater,
            R.layout.fragment_pre_login_basic_info,
            container,
            false
        )
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        basicInfoViewModel.isPreLoginContinueClickedMutableLiveData.observe(
            requireActivity(),
            Observer {
                if (it) {
                    findNavController().navigate(R.id.action_PreLoginBasicInfoFragment_to_PreLoginTimingsFragment)
                }
            })
